...
echo -e "\n cloning github repository -> 'FAJINSTA' ...\n"
git clone https://github.com/fajarkhfi/FAJINSTA
echo -e "\n install module and requirements ...\n"
cd FAJINSTA && python3.10 -m pip install --upgrade pip && python3.10 -m pip install wheel && python3.10 -m pip install -r requirements.txt
